        ...
        while (inserimentoAttivo) {
            ...
            while (true) {
                try {
                    ...
                    System.out.println("[ERRORE] Le copie ricevute non possono essere negative. Riprova.");
            ...
            while (true) {
                try {
                    System.out.print("Aggio (percentuale di guadagno tra 0 e 100): ");
                    aggio = Double.parseDouble(scanner.nextLine());
                    if (aggio >= 0 && aggio <= 100) break; 
                    System.out.println("[ERRORE] L'aggio deve essere una percentuale compresa tra 0 e 100. Riprova.");
                } catch (NumberFormatException e) {
